    ...
    <?php
        ...
        <tr>
          ...
          <td width="100">
           ...
           <a href="" data-title="Add Prescription" data-json='<?php echo json_encode( $jsonData ); ?>' data-url="<?php echo base_url(); ?>/Pathologys/Addprescription" class="btn btn-sm btn-danger btn-inline delete_confirm dialog_open"><i class="fa fa-plus" aria-hidden="true"></i> </a>
           <a href="<?php echo base_url().'/pathologys/appoinments/'.$pathologyId.'/'.$patient[0]->id; ?>" class="btn btn-sm btn-danger btn-inline delete_confirm"><i class="fa fa-list" aria-hidden="true"></i></a>
