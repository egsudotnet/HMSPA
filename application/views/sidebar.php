...
<div class="col-md-3 left_col">
    <div class="left_col scroll-view">
        <div class="navbar nav_title" style="border: 0;">
            <!-- <a href="<?php echo base_url(); ?>" class="site_title"><i class="fa fa-flask"></i> <span>HMS-PA</span></a> -->
            <a href="#" class="site_title"><i class="fa fa-flask"></i> <span>HMS-PA</span></a>
        </div>
        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            ...
            <a href="<?php echo base_url(); ?>"><i class="fa fa-home"></i> Dashboard</a>
                    ...
                    <li>
                        <a href="<?php echo base_url(); ?>pathologys/add"><i class="fa fa-flask"></i> Pathology</a>
                    </li>
              ...
              <li>
                <a href="javascript:;">
                  <span>Settings</span>
                        ...
                        <li><a href="<?php echo base_url('user/logout'); ?>"><i class="fa fa-sign-out pull-right"></i>
                                Log Out</a></li>
                    </ul>
                </li>
